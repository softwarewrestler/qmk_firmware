...
#define _________________QWERTY_L1_________________ KC_ESC,   KC_1,     KC_2,     KC_3,     KC_4,     KC_5
#define _________________QWERTY_L2_________________ KC_TAB,   KC_Q,     KC_W,     KC_E,     KC_R,     KC_T
#define _________________QWERTY_L3_________________ KC_LCTL,  KC_A,     KC_S,     KC_D,     KC_F,     KC_G
#define _________________QWERTY_L4_________________ KC_LSFT,  KC_Z,     KC_X,     KC_C,     KC_V,     KC_B
#define _________________QWERTY_L5_________________ FN,       DBG,      KC_LALT,  LOWER,    KC_LGUI,  LOWER
...
#define _________________QWERTY_R3_________________           KC_H,    KC_J,      KC_K,     KC_L,     KC_SCLN,  KC_CTEN
#define _________________QWERTY_R4_________________           KC_N,    KC_M,      KC_COMM,  KC_DOT,   KC_SLASH, KC_RSFT
#define _________________QWERTY_R5_________________           KC_SPC,  KC_RGUI,   RAISE,    KC_RALT,  RAISE,    RAISE
...
#define __________________LOWER_L3_________________ _______,  KC_CAPP,  _______,  _______,  _______,  _______
#define __________________LOWER_L4_________________ _______,  KC_CPYP,  _______,  _______,  _______,  _______
#define __________________LOWER_L5_________________ _______,  _______,  _______,  _______,  _______,  _______

#define __________________LOWER_R1_________________           _______,  _______,  _______,  KC_MINS,  KC_EQL,   _______
#define __________________LOWER_R2_________________           _______,  _______,  KC_LPRN,  KC_RPRN,  _______,  _______
#define __________________LOWER_R3_________________           _______,  _______,  KC_LCBR,  KC_RCBR,  KC_QUOT,  _______
#define __________________LOWER_R4_________________           _______,  _______,  KC_LBRC,  KC_RBRC,  _______,  _______
#define __________________LOWER_R5_________________           _______,  _______,  KC_MNXT,  KC_VOLD,  KC_VOLU,  KC_MPLY

#define __________________RAISE_L1_________________ KC_GRV,   _______,  _______,  _______,  _______,  _______
#define __________________RAISE_L2_________________ _______,  _______,  _______,  _______,  _______,  _______
...
#define __________________RAISE_R1_________________           _______,  _______,  _______,  _______,  _______,  _______
#define __________________RAISE_R2_________________           _______,  _______,  _______,  _______,  _______,  _______
...
#define __________________RAISE_R5_________________           _______,  _______,  _______,  _______,  _______,  _______

#define __________________FN_L1_________________ KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6
#define __________________FN_L2_________________ _______,  _______,  _______,  _______,  _______,  _______
#define __________________FN_L3_________________ _______,  _______,  _______,  _______,  _______,  _______
#define __________________FN_L4_________________ _______,  _______,  _______,  _______,  _______,  _______
#define __________________FN_L5_________________ _______,  _______,  _______,  _______,  _______,  _______

#define __________________FN_R1_________________           KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12
#define __________________FN_R2_________________           _______,  _______,  _______,  _______,  _______,  _______
#define __________________FN_R3_________________           KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT,  _______,  _______
#define __________________FN_R4_________________           _______,  _______,  _______,  _______,  _______,  _______
#define __________________FN_R5_________________           _______,  _______,  _______,  _______,  _______,  _______

#define __________________DBG_L1_________________ KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6
#define __________________DBG_L2_________________ _______,  _______,  _______,  _______,  _______,  _______
#define __________________DBG_L3_________________ _______,  _______,  _______,  _______,  _______,  _______
#define __________________DBG_L4_________________ _______,  _______,  _______,  _______,  _______,  _______
#define __________________DBG_L5_________________ _______,  _______,  _______,  _______,  _______,  _______

#define __________________DBG_R1_________________           KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12
#define __________________DBG_R2_________________           _______,  _______,  _______,  _______,  _______,  _______
#define __________________DBG_R3_________________           _______,  KC_F8,    KC_F10,   KC_F11,   _______,  _______
#define __________________DBG_R4_________________           _______,  KC_RSM,   KC_F8,    KC_F7,    _______,  _______
#define __________________DBG_R5_________________           _______,  _______,  _______,  _______,  _______,  _______
